              ...
              <div className=' border'>
                <div className='bg-white defaultCard border-left-0'>
                  <div className='header d-flex align-items-center '>
                    <Col
                      xs={toggle ? 3 : 1}
                      className='p-3 border-right justify-content-center d-flex headerBack'
                    >
                    ...
                    <Col xs={toggle ? 5 : 9}>
                      <h5 className='ml-4 text-muted d-flex text-center pt-2'>
                        {!toggle && data.address[0]}
                      </h5>
                    </Col>

                    <Col
                      xs={toggle ? 2 : 1}
                      className='p-3  justify-content-center d-flex '
                    >
                    ...
                    <Col
                      xs={toggle ? 2 : 1}
                      className='p-3 border-left justify-content-center d-flex headerBack'
                    >
