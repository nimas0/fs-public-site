...
export default ({ shown, hide, AuthUser }) => {
   ...
   return (
      <Modal show={shown} onHide={closeModal} backdrop={sending ? 'static' : true} size='lg'>
         <Modal.Header>
               ...
               AuthUser
                  ...
                  : {
                       ...
                       email: Yup.string()
                          ...
                          .required("Email address is required if you aren't logged in."),
                       phone: Yup.string(),
                       question: Yup.string().required(),
                    }
            )}
            ...
            {({ handleSubmit, values, handleChange, handleBlur, touched, errors }) => (
               <Form noValidate onSubmit={handleSubmit}>
                  <Modal.Body>
                        ...
                        <>
                           ...
                           <Form.Row>
                              ...
                              <Form.Group controlId='phone' as={Col} sm={6}>
                                 ...
                                 <small id='phone-optional' className='text-muted font-italic'>
                                    (optional)
                                 </small>
                                 <Form.Control
                                    name='phone'
                     ...
                     <div id='disclaimer' className='text-dark' style={{ fontSize: '0.9em' }}>
                        <p>
                           This is a no-commitment question. We do not share your email address or
                           phone number with the homeowner.
                        </p>
                        <p className='mb-2'>
                           To communicate directly with the homeowner, please create a free account
                           and subscribe to this home's updates.
                        </p>
                     </div>
                  </Modal.Body>
