...
const initData = {
    heading: "Why hire a Realtor when you have all the same tools they use?",
    ...
    formText: "No cost for using our service! You may purchase yard signs, photography, and all other services through our easy to use portal",
    formBtn: "CLICK TO GET STARTED",
                ...
                <div className="container">
                    <div className="row align-items-center justify-content-center">
                        ...
                        <div className="col-12 col-md-8 col-lg-5">
                            {/* Contact Box */}
                            <div className="contact-box bg-white text-center rounded p-2 p-sm-5 mt-5 mt-lg-0 shadow-lg">
                                {/* Contact Form */}
