              ...
              <div className="row">
                ...
                <div className="col-12 col-md-4">
                  ...
                  <div className="text-center p-3">
                    ...
                    <p className="">4-6% is what most real estate agents charge for their services.</p>
                    <p className="">Selling yourself cost absolutely nothing
                    </p>
                  </div>
                </div>
                <div className="col-12 col-md-4">
                  ...
                  <div className=" text-center p-3">
                    ...
                    <p className="">Real estate agents aren’t always incentivized to work in your best interest. Finding an agent that is loyal and you can trust can be like finding a needle and a haystack.
                    </p>
                ...
                <div className="col-12 col-md-4">
                  ...
                  <div className=" text-center p-2">
                    ...
                    <p className="">You know yourself and your home better than anyone
                    </p>
                    <p className="">Controlling the process means doing it your way
                    </p>
                  </div>
                </div>
