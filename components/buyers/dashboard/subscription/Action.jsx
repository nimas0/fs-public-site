      ...
      <Row>
        <Col>
          <Button
            ...
            className='mb-3 bg-info buttonShadow rounded-0'
            block
          >
            Chat
          </Button>
          {!isAccepted && (
            <Button
              ...
              variant={
                status === "pending" || "approved" ? "primary" : "secondary"
              }
              className='mb-1 buttonShadow rounded-0 bg-info'
              block
            >
              {isActive && isProposed ? "View Proposal" : "Propose Offer"}
            </Button>
          )}
          ...
          <Button
            ...
            className='mb-0 buttonShadow bg-info rounded-0'
            block
          >
            Request Showing
          </Button>
...
const ModalBody = () => (
  <>
    <p>
      A mortgage approval allows you to make an offer with confidence and shows
      that you're a serious buyer with the means to purchase the seller's home.
      Please submit a pre-approval or proof of funds to unlock this feature.
    </p>
  </>
);
