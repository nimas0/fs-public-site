            ...
            <>
               ...
               <Modal.Body className='pt-5  bg-light px-3 text-center text-secondary'>
                  {/* {renderAuth ? (
                     ...
                     Beta version with all features is available in: <h2 className='mt-4'><Countdown  renderer={props => <h6>{props.days} days | {props.hours} hrs | {props.minutes} min | {props.seconds} secs</h6>} date={new Date(2020, 10, 14)} /></h2>
               </Modal.Body>
